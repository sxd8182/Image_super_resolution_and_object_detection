...
EPOCHS = 25
BATCH = 32
RESULT_CSV = "/mnt/users/sdevkota/output/upscale_experiments_256_to_640_using_RealESRGAN/results_real_esrgan256to640.csv"
...
for res in RES_LIST:
    ...
    exp_dir = f"/mnt/users/sdevkota/output/upscale_experiments_256_to_640_using_RealESRGAN/train_from_{res}_to_{BASE_RES}"

...
EPOCHS = 25
BATCH = 32
RESULT_CSV = "/mnt/users/sdevkota/output/upscale_experiments_128_to_640_using_SR/results_128_to_640_using_SR.csv"
...
for res in RES_LIST:
    ...
    exp_dir = f"/mnt/users/sdevkota/output/upscale_experiments_128_to_640_using_SR/train_from_{res}_to_{BASE_RES}"
...
print(f"\n Experiment Concluded and all results saved to {RESULT_CSV} from experiment downscale upscale 128 to 640 using SR")

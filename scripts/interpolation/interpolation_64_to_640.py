...
EPOCHS = 25
BATCH = 32
RESULT_CSV = "/mnt/users/sdevkota/output/upscale_experiments_64_to_640_corrected/results_64_to_640_corrected.csv"
...
for res in RES_LIST:
    ...
    exp_dir = f"/mnt/users/sdevkota/output/upscale_experiments_64_to_640_corrected/train_from_{res}_to_{BASE_RES}"
